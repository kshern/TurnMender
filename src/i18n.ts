...
const zhCN = {
  ...
  "settings.messageHint": "普通任务会原样发送这段内容；目标模式会直接恢复目标。",
...
const en = {
  ...
  "settings.messageHint": "Normal tasks receive this text as written; Goal mode resumes the goal directly.",
  "settings.messageCount": "{count}/{max}",
  ...
  "status.goalResumed": "Goal resumed automatically",
