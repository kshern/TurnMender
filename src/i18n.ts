...
const zhCN = {
  ...
  "settings.limitHint": "达到上限后转为人工处理，可设置 {min}–{max} 次。",
  ...
  "settings.error.invalidLimit": "连续上限必须是 {min}–{max} 之间的整数。",
  ...
  "retry.limitUnit": "次",
  "retry.limitAria": "连续自动继续上限，可设置 {min} 到 {max} 次",
...
const en = {
  ...
  "settings.limitHint": "Switch to manual handling at the limit; choose {min}–{max}.",
  ...
  "settings.error.invalidLimit": "The limit must be a whole number from {min} to {max}.",
  ...
  "retry.limitAria": "Consecutive automatic continuation limit, from {min} to {max}",
